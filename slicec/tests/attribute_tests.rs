...
mod attributes {
    ...
    mod allow {
        ...
        fn allow_with_invalid_argument() {
            ...
            // Assert
            let expected = Diagnostic::from_error(Error::InvalidAttributeArgument {
    ...
    mod slice_api {
        ...
        fn sliced_format_only_works_on_operations() {
            ...
            // Assert
            let expected = Diagnostic::from_error(Error::InvalidAttribute {
                directive: "slicedFormat".to_owned(),
            })
        ...
        fn deprecated_type_alias() {
            ...
            // Assert
            let expected = Diagnostic::from_lint(Lint::Deprecated {
    ...
    mod generalized_api {
        ...
        fn unknown_attributes_are_rejected(directive: &str) {
            ...
            // Assert
            let expected = Diagnostic::from_error(Error::UnknownAttribute {
