...
mod associated_fields {
    ...
    fn tags_are_disallowed_in_compact_enums() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::CompactTypeCannotContainTaggedFields { kind: "enum" })
    ...
    fn explicit_values_must_be_within_range() {
        ...
        // Arrange
        let expected = [
            Diagnostic::from_error(Error::EnumeratorValueOutOfBounds {
    ...
    fn checked_enums_can_not_be_empty() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::MustContainEnumerators {
...
mod underlying_type {
    ...
    fn associated_fields_are_not_allowed() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::EnumeratorCannotContainFields {
    ...
    fn validate_backing_type_out_of_bounds() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::EnumeratorValueOutOfBounds {
    ...
    fn enumerators_must_have_unique_values() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::DuplicateEnumeratorValue { enumerator_value: 1 })
    ...
    fn duplicate_enumerator_values_are_disallowed_across_different_bases() {
        ...
        // Assert
        let expected = Diagnostic::from_error(Error::DuplicateEnumeratorValue { enumerator_value: 79 });
        check_diagnostics(diagnostics, [expected]);
    }
