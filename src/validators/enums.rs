...
pub fn enum_validators() -> Vec<ValidationFunction> {
    return vec![
        ValidationFunction::Enums(Box::new(backing_type_bounds)),
        ValidationFunction::Enums(Box::new(allowed_underlying_types)),
        ValidationFunction::Enums(Box::new(enumerators_are_unique)),
        ValidationFunction::Enums(Box::new(underlying_type_cannot_be_optional)),
        ValidationFunction::Enums(Box::new(nonempty_if_checked)),
    ];
}
