...
use crate::{implement_error_functions, implement_from_for_error_kind_sub_kind};
...
implement_from_for_error_kind_sub_kind!(LogicErrorKind, super::ErrorKind::LogicError);
