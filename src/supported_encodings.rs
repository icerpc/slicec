...
impl SupportedEncodings {
    ...
    /// This is used internally by the compiler to avoid reporting redundant error messages.
    ///
    /// For example, if a class is declared in an 'encoding = Slice2' file, we report an error for it,
